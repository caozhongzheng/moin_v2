 ...
 */
public class DownloadImageView extends ImageView implements OnClickListener {
    private static ILogger MyLog = LoggerFactory.getLogger("DownloadImageView");
    ...
    private void updateViewByStatus(int appStatus) {
        ...
        switch (appStatus) {
            case MyDownloadManager.STATUS_NONE:
                ...
                setImageDrawable(context.getResources().getDrawable(R.drawable.btn_download));
                break;
            case MyDownloadManager.STATUS_RUNNING:
                ...
                setBackgroundResource(R.drawable.cosplay_download);
            ...
            case MyDownloadManager.STATUS_SUCCESSFUL:
                ...
                setImageDrawable(context.getResources().getDrawable(R.drawable.icon_select));
                break;
            default:
                setImageDrawable(context.getResources().getDrawable(R.drawable.btn_download));
                break;
