 ...
 * 用户注册的服务器接口
 */
public class UserRetrievePasswordProtocal extends HttpPostProtocal implements HttpObserver {
    // ===========================================================
    // Fields
    // ===========================================================
    ...
    // Constructors
    // ===========================================================
    public UserRetrievePasswordProtocal(String url, Map data, Object tag) {
        super(url, data);
        setTag(tag);
    }
    ...
    public void onHttpResult(int resultCode, String respone) {
        MyLog.i("UserRetrievePasswordProtocal.onHttpResult()... resultCode=" + resultCode + ", response=" + respone);
        if (resultCode == AbsHttpOperation.ERROR_NONE) {
            EventBus.getDefault().post(new RetrievePasswordSuccessEvent(respone, getTag()));
        } else {
    ...
    // inner class
    // ===========================================================
    public static class RetrievePasswordSuccessEvent extends AbsProtocolEvent {
        private String mResponse;

        public RetrievePasswordSuccessEvent(String resp, Object tag) {
            setTag(tag);
            mResponse = resp;
        }
