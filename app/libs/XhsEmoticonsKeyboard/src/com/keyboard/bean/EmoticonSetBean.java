...
public class EmoticonSetBean {
    ...
    public EmoticonSetBean(String id , String name , int line , int row){
        this.id = id;
        this.name = name;
        this.line = line;
        this.row = row;
    ...
    public EmoticonSetBean(String id, int order, String name, int line, int row, String iconUri, String iconUrl, String iconName, boolean isShowDelBtn,
                           int itemPadding, int horizontalSpacing, int verticalSpacing, int updateTime, ArrayList<EmoticonBean> emoticonList){
        this.id = id;
        this.order = order;
        this.name = name;
        this.line = line;
